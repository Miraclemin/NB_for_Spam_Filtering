...
for fileName in normFileList:
    wordsList.clear()
    os.system("type ./../data/normal/"+fileName+" > ./../data/normal/"+fileName)
    for line in open("./../data/normal/"+fileName,encoding="utf-8"):
        #过滤掉非中文字符
...
for fileName in spamFileList:
    wordsList.clear()
    os.system("type ./../data/spam/"+fileName+" > ./../data/spam/"+fileName)
...
for fileName in testFileList:
    ...
    wordsDict.clear()
    wordsList.clear()
    os.system("type ./../data/test/"+fileName+" > ./../data/test/"+fileName)
    for line in open("./../data/test/"+fileName,encoding="utf-8"):
        rule=re.compile(r"[^\u4e00-\u9fa5]")
        line=rule.sub("",line)
        spam.get_word_list(line,wordsList,stopList)
    spam.addToDict(wordsList, wordsDict)
